...
namespace YandexMobileAds.Platforms.iOS
{
    ...
    internal class InterstitialAdLoaderClient : IInterstitialAdLoaderClient, IDisposable
    {
        ...
        {
            AdRequestConfigurationClient adRequest = null;
            if (adRequestConfiguration != null)
            {
                adRequest = new AdRequestConfigurationClient(adRequestConfiguration);
            }
            InterstitialAdLoaderBridge.YMAUnityLoadInterstitialAd(

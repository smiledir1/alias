...
namespace YandexMobileAds.Platforms.Android
{
    public class BannerClient : AndroidJavaProxy, IBannerClient
    {
        ...
        public BannerClient(string blockId, BannerAdSize bannerAdSize, AdPosition position) : base(Utils.UnityBannerAdListenerClassName)
        {
            ...
            this.bannerView = new AndroidJavaObject(
                ...
                activity,
                blockId,
                BannerAdSizeUtils.GetBannerAdSizeJavaObject(bannerAdSize),
                (int)position
            );

...
{
    [CustomPropertyDrawer(typeof(ColorImageTween), true)]
    public class ColorImageTweenDrawer : SimpleTweenDrawer
    {
        ...
        {
            if (TargetTween is not ColorImageTween colorImageTween) return;
